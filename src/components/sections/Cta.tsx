...
export default function CTA() {
  const stats = [
    { value: '6', label: 'Luxury Properties', icon: MapPin },
    { value: '4.9', label: 'Guest Rating', icon: Star },
    { value: '98%', label: 'Occupancy Rate', icon: Calendar },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Miami Beach's Premier Vacation Rentals
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of satisfied guests who have chosen Coastal Retreats for their Miami
                Beach getaway. Book your oceanfront paradise today and create unforgettable
                memories.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Licensed & Insured • Featured on Leading Travel Platforms
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Fully licensed vacation rentals with comprehensive coverage
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personalized concierge service and insider Miami Beach tips
              </p>
            </div>
          </div>
        </div>
